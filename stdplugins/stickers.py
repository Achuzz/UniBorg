...
async def _(event):
    ...
    packname = f" തൊണ്ടിമുതൽ @Noo-One_Cares 🤒 "
    ...
    await event.edit("kanging on . please wait !")
    ...
    await event.edit(f"കട്ടുബോധിച്ചു 😌😌 [ഇവിടെ നോക്ക് ](t.me/addstickers/{packshortname})")
